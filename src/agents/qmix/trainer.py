...
class QMIXTrainer:
    ...
    def train(self):
        ...
        while self.episodes_done < self.total_training_episodes:
            ...
            if self.should_eval and self.episodes_done % self.eval_freq_episodes == 0:
                ...
                if eval_reward > self.best_eval_reward:
                    ...
                    self.agent.save_models(
                        os.path.join(self.experiment_dir, "checkpoints", "best.pth")
                    )
                    print_colored(
            ...
            if self.episodes_done % self.save_freq_episodes == 0:
                checkpoint_path = os.path.join(
                    self.experiment_dir, "checkpoints", f"checkpoint_{self.episodes_done}.pth"
                )
        ...
        self.agent.save_models(os.path.join(self.experiment_dir, "checkpoints", "final.pth"))
